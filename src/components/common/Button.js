  ...
  if (variant === "primary") {
    return (
      <Component
        ...
        {...props}
      >
        <span className="w-full h-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#090d18] text-white font-semibold text-sm sm:text-base transition-colors group-hover/btn:bg-[#0f1424]">
